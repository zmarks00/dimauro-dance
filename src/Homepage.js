...
function Homepage() {
  return (
    <main className="main">
      ...
      <section id="about" className="about section">
        <div className="container section-title" data-aos="fade-up">
          ...
          <p className="bio__text">
            <b>Jessica DiMauro Marks</b>, a New York native, is a modern dance
            choreographer invested in creating work that is rich in physicality
            and deeply communicative. Ms. DiMauro Marks holds an MFA in
            Choreography from Jacksonville University and a BFA in Dance from
            Marymount Manhattan College. She has taught and choreographed works
            extensively for both pre-professional and professional dance
            companies throughout the US. Ms. DiMauro’s company, DiMauro Dance,
            has been selected to perform at numerous curated festivals including
            Dance Conversations at The Flea, WHITE WAVE's WAVE RISING Series,
            COOL NY and DUMBO Dance Festivals, The T: Dance, Watch, Reflect,
            Greenspace Blooms, The HATCH presenting series, CT Meets NY, Queens
            Arts Express and New Dance Downtown. Ms. DiMauro Marks has
            self-produced many seasons for her Company, including I'm not done
            yet. at St. Mark's Church-in-the-Bowery (2018), METROPOLIS at
            Manhattan Movement & Arts Center (2015), Unraveled at the Merce
            Cunningham Studio (2011) and Confetti: A Collection of Works by
            Jessica DiMauro at The Producers’ Club Theaters (2003). Ms. DiMauro
            Marks was awarded an Arts Alive Artist Grant from ArtsWestchester
            for her evening length work entitled com-mu-ni-ty. Her choreography
            was also seen at the 2004 International NYC Fringe Festival in
            Granola! The Musical at The Michael Schimmel Center for the Arts.
            Jessica has been teaching Modern Technique and choreographing at
            Montclair State University for eighteen years. In the fall of 2024,
            she set her nineteenth work on the students of the Dance Department
            at MSU. She is on faculty at Marymount Manhattan College, and also
            acts as Artistic Director for the Steffi Nossen School of Dance, a
            modern dance organization active for over 87 years in White Plains,
            NY. She is a frequent guest artist for workshops and intensives
            throughout the tri-state area including the Martha Graham School and
            Earl Mosley’s Institute of the Arts. In 2013, Ms. DiMauro Marks was
            proud to be among the first few students to be certified in May
            O’Donnell Technique. Jessica is a Certified Kripalu Yoga Teacher,
        ...
        <div className="container" data-aos="fade-up" data-aos-delay="100">
          <div className="row gy-4 justify-content-center">
            <div className="col-lg-4">
              <img
                src="assets/img/JessieByTrainFence.jpg"
                className="img-fluid"
                alt=""
              />
            </div>
            <div className="col-lg-8 content">
              ...
              <p className="fst-italic py-3">
                <b>
                  Technique is the skeleton of our work. Human emotions are the
                  muscles that move our creative process.{" "}
                </b>{" "}
                As a choreographer deeply invested in the artistic exploration
                of the human experience, Jessica DiMauro has always been
                intrigued by the challenge of developing literal gesture into
                abstract movement while keeping the emotional integrity. In the
                company's work, the body is used as a vessel to express the rich
                layers of human emotion. DiMauro is constantly fascinated by the
                body’s ability to express subtlety and grace, and conversely
                show aggression and struggle. Her choreography tells a story or
                sheds light on a particular subject, while giving the performer
                the opportunity to viscerally experience the emotional intention
                through movement. She composes movement that is structurally
                athletic and emotionally driven. Through performances that
                utilize community participation as a foundation, the company has
                made it a goal to bring the public into the world of concert
                dance; specifically the infrequent dance spectator who is
                intimidated, frustrated or confused by the opacity of modern
                dance. As an artist, DiMauro wants to create work that
                entertains with depth. Personal stories and emotional journeys
                are revealed through movement that is accessible and experienced
                  ...
                  <ul className="list__items">
                    <li>
                      ...
                      <span>
                        <ul>
                          <li>DAVON CHANCE</li>
                          <li>NAJEE STEPHENSON</li>
                          <li>CRYSTAL RODRIGUEZ</li>
                          <li>ALEXANDRA WILLIAMSON</li>
                        </ul>
                      </span>
                    </li>
      ...
      <section id="yoga" className="services section">
        <div className="container section-title" data-aos="fade-up">
          <span className="description-title">YOGA</span>
          <h2>YOGA</h2>
          <p className="yoga__text">
            <b>Jessica DiMauro Marks</b> began practicing yoga as a compliment
            to her dance training over twenty years ago. It wasn’t until a
            serious dance injury that she began to truly dive into a regular
            practice. Since then, yoga has played an integral role in her life
            and she has made it a goal to bring her love of movement into the
            lives of others through a yoga practice rooted in compassion. She
            received her 200-hour certification in 2012 from the Kripalu School
            of Yoga. She has also completed her 85-hour certification in
            Prenatal and Postnatal yoga. Jessica's classes provide a heightened
            focus on alignment within a flow-based practice. Honoring the
            Kripalu tradition, compassionate self-awareness is encouraged and
            practiced through unique pose sequencing. Students are guided to
            listen to the needs of their bodies in the present and modifications
            for poses are given. Props are encouraged! Supporting students
            through mindful movement is the goal of each class.
          </p>
        </div>
          ...
          <div className="container-fluid">
            ...
            >
              ...
              >
                <ComponentExample
                  filter={"headshots"}
                  imgURL={"assets/img/portfolio_cropped/portfolio17.jpg"}
                />
                ...
                <div className="info-item d-flex flex-column justify-content-center align-items-center info-item-borders">
                  ...
                  <h3>
                    <a
                      ...
                      href="https://app.thefield.org/profile/Jessica-DiMauro-Marks---DiMauro-Dance/550794"
                      target="_blank"
                    >
                      Donate Here
                    </a>
